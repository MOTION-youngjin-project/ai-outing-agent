  ...
  const paths: Record<string, React.ReactNode> = {
    ...
    exit: (
      <>
        ...
        <path d="M10.5 8l-4 4 4 4M2.5 12h12" />
      </>
    ),
    checkCircle: (
      <>
        <path d="M12 3.5c2.2 0 3.4 1 3.4 1s1.6-.4 2.7.7 1.3 2.6.7 2.7c0 0 1 1.2 1 3.1s-1 3.1-1 3.1c.6.1-.1 1.7-1.2 2.7s-2.6.6-2.6.6-1.2 1-3 1-3-1-3-1-1.6.4-2.7-.6-1.2-2.6-1.2-2.7c0 0-1-1.2-1-3.1s1-3.1 1-3.1c-.6-.1.1-1.7 1.2-2.7s2.7-.7 2.7-.7 1-1 3-1z" />
